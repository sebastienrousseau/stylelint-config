...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/stylelint-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fstylelint-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/stylelint-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14520"><img src="https://img.shields.io/cii/level/14520?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [CSS & SCSS Quality Assurance](#css--scss-quality-assurance) — before and after rule comparison
...
Install `@sebastienrousseau/stylelint-config` as a development dependency:
...
Stylelint extends shareable configurations by package name.
...
`@sebastienrousseau/stylelint-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/stylelint-config` solves this with three deliberate engineering choices:
...
When your codebase does not use CSS, SCSS, or PostCSS, or uses CSS-in-JS solutions that do not support standard Stylelint AST visitors.

...
This document describes how @sebastienrousseau/stylelint-config is run: who decides what, how
...
@sebastienrousseau/stylelint-config is **maintainer-led**. As of the current release line it has a single

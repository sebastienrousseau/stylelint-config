...
%global npm_bare      stylelint-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-stylelint-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Stylelint CSS/SCSS linting configuration rules

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/stylelint-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/stylelint-config is a shareable configuration preset with no runtime

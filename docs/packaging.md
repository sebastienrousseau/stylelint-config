...
# Packaging @sebastienrousseau/stylelint-config
...
Peer dependency: `stylelint >=16.0.0`.
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/stylelint-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/stylelint-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/stylelint-config/` |
| Homebrew | [`pkg/brew/stylelint-config.rb`](../pkg/brew/stylelint-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/stylelint-config/` |
